const CASE_STUDIES = [
    {
        ...
        titleLabelWords: 0,
        metaTitle: "Eliot's Adventures: The Work | Full-Stack Tour Booking System | URAWAKE",
        ...
        duration: "4 months (Feb to Jun 2026)",
...
The business went from zero online presence to a fully operational booking system in 4 months.`,
    ...
    },
    {
        ...
        titleLabelWords: 2,
        metaTitle: "Eliot's Adventures CRM: The Work | Custom Booking & Operations Platform | URAWAKE",
...
The CRM launched alongside the public website and handled over 100 bookings and 130 waivers in its first 4 months in production.`,
    ...
    },
    {
        ...
        title: "Tours ToDo PR",
        titleLabelWords: 0,
        metaTitle: "ToursToDo PR: The Work | Custom CRM & Email Automation | URAWAKE",
        metaDescription: "How URAWAKE built a custom CRM from scratch for a Puerto Rico adventure tour operator. Automated bookings, drip sequences, affiliate portal, and 8 integrations in one system.",
        subtitle: "From zero infrastructure and manual Gmail replies to a fully custom CRM with automated flows, campaign engine, and affiliate portal",
