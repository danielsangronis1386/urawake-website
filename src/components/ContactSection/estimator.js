...
export const STEPS = [
    {
        ...
        options: [
            ...
            { value: "ecommerce", label: "E-commerce",             price: 1400 },
    ...
    },
    {
        ...
        options: [
            ...
            { value: "2-5",   label: "2 to 5",   price: 250 },
            { value: "6-10",  label: "6 to 10",  price: 550 },
            { value: "10+",   label: "10+",      price: 950 },
        ],
    },
    {
        id: "design",
        ...
        options: [
            ...
            { value: "no",       label: "No",                   price: 150 },
            { value: "included", label: "Need design included", price: 450 },
        ],
    },
    {
        id: "features",
        ...
        options: [
            { value: "auth",     label: "Authentication",   price: 250 },
            { value: "booking",  label: "Booking System",   price: 400 },
            { value: "payments", label: "Payments",         price: 300 },
            { value: "admin",    label: "Admin Dashboard",  price: 550 },
            { value: "cms",      label: "CMS",              price: 300 },
            { value: "blog",     label: "Blog",             price: 150 },
            { value: "api",      label: "API Integrations", price: 300 },
